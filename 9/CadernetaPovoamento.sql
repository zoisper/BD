...
INSERT INTO Equipa
	...
	VALUES
		...
		('SLB','Sport Lisboa e Benfica','LIS','Jorge Jesus',1904,'Luz','Luis Filipe Vieira','www,slbenfica.pt'),
		('BFC','Boavista Futebol Clube','POR','Erwin Sánchez',1903,'Bessa Século XXI','João Loureiro','www,boavistafc.pt'),
		('SCB','Sporting Clube de Braga','BRG','Carlos Carvalhal',1921,'Axa','António Salvador','www,scbraga.pt'),
		...
		('FCP','Futebol Clube do Porto','POR','Sergio Conceição',1893,'Dragão','Pinto da Costa','www,fcporto.pt'),
		('RAF','Rio Ave Futebol Clube','VDC','Nuno Capucho',1939,'Rio Ave FC','António Silva Campos','www,rioavefc.pt'),
		('SCP','Sporting Clube de Portugal','LIS','Ruben Amorim',1906,'José Alvalade','Bruno de Carvalho','www,sporting.pt'),
